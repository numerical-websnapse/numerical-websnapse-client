<script>
  ...
  const modalDeselect = (e) => {
    ...
    const isWithinButton = e.target.closest("button") !== null;
...
<div
  id={dropdownId}
  class="absolute z-1 hidden w-full bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700"
>
